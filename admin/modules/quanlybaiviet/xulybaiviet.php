...
<?php
	...
	if(isset($_POST['thembaiviet'])){
		...
		$sql_insert_product = mysqli_query($con,"INSERT INTO baiviet(tenbaiviet,tomtat,noidung,danhmuctin_id,baiviet_image) values ('$tenbaiviet','$mota','$chitiet','$danhmuc','$hinhanh')");
		...
		if($hinhanh==''){
			...
			move_uploaded_file($hinhanh_tmp,$path.$hinhanh);
			$sql_update_image = "UPDATE baiviet SET tenbaiviet='$tenbaiviet',noidung='$chitiet',tomtat='$mota',danhmuctin_id='$danhmuc',baiviet_image='$hinhanh' WHERE baiviet_id='$id_update'";
		}
		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<?php
					$sql_danhmuc = mysqli_query($con,"SELECT * FROM danhmuc_tin ORDER BY danhmuctin_id DESC"); 
					?>
			...
			<div class="col-md-8">
				...
				<?php
				$sql_select_bv = mysqli_query($con,"SELECT * FROM baiviet,danhmuc_tin WHERE baiviet.danhmuctin_id=danhmuc_tin.danhmuctin_id ORDER BY baiviet.baiviet_id DESC"); 
				?> 
